...
export const TypingIndicator: React.FC = () => {
    return (
        <div className="flex items-center space-x-2 self-start">
            <div className="w-10 h-10 flex items-center justify-center bg-[#2b2b2b] rounded-full flex-shrink-0">
                <svg className="w-6 h-6 text-[#00BFFF]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <div className="flex items-center space-x-1.5 bg-[#2b2b2b] px-4 py-3 rounded-xl">
                <div className="w-2 h-2 bg-[#666666] rounded-full animate-bounce" style={{ animationDelay: '0s' }}></div>
